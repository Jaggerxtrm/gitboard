...
For task-specific workflows (exploring, impact analysis, debugging, refactoring), load the matching `/gitnexus-*` skill rather than reading per-skill SKILL.md paths from here.
<!-- gitnexus:end -->
